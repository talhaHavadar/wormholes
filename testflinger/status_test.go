...
func TestClassifyQueue(t *testing.T) {
	...
	cases := []struct {
		...
		{"transient busy, nothing waiting", queueStatus{Agents: []queueAgent{agent("test")}}, nil, false, true},
		{"reserved, nothing waiting", queueStatus{Agents: []queueAgent{agent("reserve")}}, nil, false, false},
		{"reserved, nothing waiting, wait_if_busy", queueStatus{Agents: []queueAgent{agent("reserve")}}, nil, true, true},
		{"mixed busy with a reservation, nothing waiting", queueStatus{Agents: []queueAgent{agent("reserve"), agent("test")}}, nil, false, true},
